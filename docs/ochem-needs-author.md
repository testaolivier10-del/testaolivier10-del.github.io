...
- **Question for the author:** confirm that this course should keep grading by the classic conventions.
...
- **Note:** the table calls ethyl acetate "the pear-drop smell of nail polish". The pear-drop smell is
  also, and perhaps more often, attributed to isoamyl acetate. Keep, reword, or change the example?
