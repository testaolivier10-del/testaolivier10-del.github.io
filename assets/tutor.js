...
(function(){
  ...
  var CSS = [
    ...
    '.lp-form button{border:none;background:var(--accent);color:var(--on-accent);border-radius:12px;padding:0 16px;',
      'font:900 14px var(--font-ui);cursor:pointer;box-shadow:var(--btn-shadow-accent);}',
  ...
  var GREETING = {
    ...
    ochem: 'Ask me anything from this course — all 112 textbook sections are indexed. I can define a term, explain a mechanism another way, or point you at the section it came from.'
  };
