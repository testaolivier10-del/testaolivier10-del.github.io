...
already listed per chapter in the status table (the recall-heavy banks
in the old chapters 12/14/17 and the three deferred figures were both done
on 2026-09-22 — see "Bank follow-up" under the status table). The status table's chapter
...
- ~~Recall-heavy banks (old chapters 12, 14, 17)~~ — **done 2026-09-22**
  ("Bank follow-up" below the status table). ~~Three deferred figures~~ —
  **done 2026-09-22**: `succinic-anhydride-imide`, `beta-lactam-acylates`,
  `polymer-disconnection` in `build-ochem-figures.mjs`.
...
| 13 Carboxylic Acids & Derivatives | yes (26/8/11/13, anchored) | yes: 8 figures (acid dimer, DMF resonance/rotation, five-panel Fischer esterification, saponification, chlorosulfite, aspirin acetylation, nitrile imine anion), 12 questions replaced and 17 edited, 12 lesson MCQs rebalanced; diacid pKa, β-keto decarboxylation, lactones/lactams, transesterification, amide O-protonation, ¹⁸O labeling now taught; mechanism walkthrough gains acid-catalysed steps. Open: cyanide SN2 panel (succinic anhydride/imide figure done 2026-09-22) | yes: 2 of 5 met on first verification; every number, mechanism arrow, ¹⁸O outcome and 149/150 keys confirmed; 5 errors (IR ladder attributes the acid's 1710 to resonance rather than dimerisation, methoxide-on-methyl-acetate walkthrough has no net change, nitriles Q8 two answers, pyridine "poorly nucleophilic", 179-vs-85 kcal/mol double count) all fixed in a second pass; walkthrough now runs methoxide on acetyl chloride; β-keto decarboxylation figure and ¹⁸O item added. Succinic anhydride/imide and β-lactam figures done 2026-09-22 | yes |
