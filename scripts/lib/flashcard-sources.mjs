...
export const AUTHORED = [
  ...
  { id: 'hvz', topic: 'alpha-halogenation', q: 'Hell–Volhard–Zelinsky reaction', ask: 'Reagents, product, and why the phosphorus?',
    a: [['Reaction', 'Carboxylic acid + Br<sub>2</sub> with catalytic PBr<sub>3</sub> (or red P) → α-bromo carboxylic acid.'],
        ['Why PBr<sub>3</sub>', 'An acid barely enolizes; PBr<sub>3</sub> converts it to the acyl bromide, which does, and that enol is what brominates.']] },
  ...
  { id: 'nbs', topic: 'benzylic-reactivity', q: 'NBS with light', ask: 'Where does it brominate, and why NBS rather than Br<sub>2</sub>?',
