...
(function(){
  ...
  L.shared([
    ...
    { o:/radical/i, c:'mechanism-selection',
      m:'Radical chemistry is a different regime entirely, initiated by light or peroxides. Ionic mechanisms move electrons in pairs, which is what a full-headed curved arrow represents (radical steps use single-barbed fishhooks instead).' },
...
(function(){
  ...
  L.define('sn1', [
    ...
    { o:/^\s*(methyl|primary)\s*$/i, c:'carbocation-stability',
      m:'Methyl and primary cations are far too unstable to form. SN1 needs a carbocation it can afford, which means tertiary, allylic or benzylic (secondary only with a weak nucleophile in a protic solvent).' },
