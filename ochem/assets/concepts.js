...
(function(){
  var CONCEPTS = [
    ...
    { id:'alkene-cleavage-scope', title:'How far an alkene oxidation goes', family:'Oxidation & reduction',
      ...
      hint:'Ask two things: does the C=C survive, and what workup follows.' },
    ...
    { id:'cip-priority', title:'CIP priority rules', family:'Stereochemistry',
      topics:['rs-configuration','fischer','enantiomers','diastereomers','cis-trans-ez'], dependsOn:['stereocenter-identification'],
      hint:'Rank by atomic number at the first point of difference; duplicate atoms for double bonds.' },
    { id:'ez-assignment', title:'E/Z assignment', family:'Stereochemistry',
      topics:['cis-trans-ez','alkene-structure'], dependsOn:['cip-priority'],
      hint:'Rank each alkene carbon on its own two groups, then compare only the two winners.' },
    { id:'ring-cis-trans', title:'Cis/trans on a ring', family:'Stereochemistry',
      topics:['cis-trans-ez','cyclohexanes'], dependsOn:['chair-axial-equatorial'],
      hint:'Same face of the ring is cis, opposite faces trans \u2014 and a ring flip changes neither.' },
    ...
    { id:'anti-periplanar-geometry', title:'Anti-periplanar geometry', family:'Substitution & elimination',
      topics:['e2','ring-flips','substrate-effects','axial-equatorial'], dependsOn:['chair-axial-equatorial','newman-reading'],
