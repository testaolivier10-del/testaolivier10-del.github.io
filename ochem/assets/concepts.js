...
(function(){
  var CONCEPTS = [
    ...
    { id:'two-reactive-sites', title:'Counting reactive sites', family:'Polymers',
      ...
      teach:'A polymer is the reactions you already know run repeatedly on a monomer with TWO reactive ends. One site gives a small molecule and stops; two gives a chain; three or more gives a cross-linked network, which is what a thermoset is. The other count that matters is atoms: compare the repeat unit with the monomer, and if the formulas match it was an ADDITION polymerization, while if the repeat unit is lighter something was condensed out and it was STEP-GROWTH. Those two counts answer most questions in the chapter before any mechanism is written.' },
    ...
    { id:'step-growth', title:'How a condensation polymer grows', family:'Polymers',
      ...
      teach:'A diacid plus a diol gives a POLYESTER and a diacid plus a diamine gives a POLYAMIDE, losing water at every join. Nylon 6,6 is adipic acid and hexamethylenediamine, the numbers counting carbons in each. A polyamide is a protein backbone made of one repeating unit: same amide, same planarity, same interchain hydrogen bonding, which is why nylon is strong for the reason a beta sheet is. Amides resist hydrolysis far better than esters, so nylon outlasts polyester. Kevlar adds aromatic para-substituted monomers, making chains rigid and straight so their hydrogen bonds line up. The kinetics differ from chain growth in a way that matters: degree of polymerization is 1/(1-p), so 90% conversion gives 10 and only 99.9% gives 1,000 — exact stoichiometry and continuous removal of the by-product are not fussiness but the whole reaction.' },
    { id:'packing-and-properties', title:'Reading a structure as a material', family:'Polymers',
      ...
      teach:'A polymer has crystalline regions where chains pack and amorphous regions where they tangle, and most properties track the crystalline fraction: more crystalline means denser, stronger, higher melting and more opaque, because crystalline regions scatter light. Linear and stereoregular chains pack; branched, atactic or bulky-substituted ones do not. Interchain hydrogen bonds, as in nylon and Kevlar, hold them together hard. This is the fatty acid argument again — straight chains stack and melt high, kinked ones do not. Two transition temperatures rather than one: Tg, where the amorphous regions unfreeze, which every polymer has, and Tm, where crystalline regions melt, which only semicrystalline ones have. Cool rubber below its Tg and it shatters like glass.' },
