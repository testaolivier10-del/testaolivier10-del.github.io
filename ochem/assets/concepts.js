...
(function(){
  var CONCEPTS = [
    ...
    { id:'activating-group', title:'A group installed to be thrown away', family:'Carbonyl breadth',
      ...
      teach:'An ester alpha hydrogen is pKa 25 and a malonate one is 13, because the carbanion is delocalized onto two oxygens. That twelve-order-of-magnitude difference is what lets sodium ethoxide do the deprotonation. Deprotonate, alkylate by SN2, then hydrolyze and heat: diethyl malonate has two esters and ends as a carboxylic acid, ethyl acetoacetate has one ester and a ketone and ends as a methyl ketone. Decarboxylation works only because the intermediate is a BETA-keto acid, which can reach a six-membered cyclic transition state; an alpha or gamma keto acid does not. The real constraint is the SN2, so the halide must be methyl, primary, allylic or benzylic - a tertiary target cannot be reached this way however neat the disconnection looks.' },
